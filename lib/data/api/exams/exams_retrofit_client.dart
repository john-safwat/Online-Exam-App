...
import 'package:online_exam_app/data/api/models/exam/exam_response_dto.dart';
import 'package:online_exam_app/data/api/models/exams_list/exams_response_dto.dart';
...
abstract class ExamsRetrofitClient {
  ...
  @GET(ApiConstants.questionRoute)
  Future<ExamResponseDto> getExamDetails(@Header("token") String token, @Query("exam") String examId);
}
