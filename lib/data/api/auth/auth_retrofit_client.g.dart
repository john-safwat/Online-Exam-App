...
class _AuthRetrofitClient implements AuthRetrofitClient {
  ...
  @override
  Future<UserInfoResponseDto> getUserInfo(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'token': token};
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<UserInfoResponseDto>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late UserInfoResponseDto _value;
    try {
      _value = UserInfoResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<UserInfoResponseDto> updateUserInfo(
    String token,
    ...
    _headers.removeWhere((k, v) => v == null);
    final _data = <String, dynamic>{};
    _data.addAll(editUserInfoRequestDto.toJson());
    final _options = _setStreamType<UserInfoResponseDto>(Options(
      method: 'PUT',
      headers: _headers,
      extra: _extra,
